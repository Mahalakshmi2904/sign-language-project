...
while True:
    ...
    if result.multi_hand_landmarks:
        ...
        # 🔥 Convert prediction to string (important)
        ...
        if predicted_char != current_char:
            ...
            if time.time() - char_start_time >= STABLE_TIME:
                ...
                cursor += 1
                current_char = ""  # allow repeated characters
    ...
    cv2.imshow("ISL Combined Detection (A-Z + 0-9)", frame)
